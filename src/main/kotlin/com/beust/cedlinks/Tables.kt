...
//    val id: Column<Long> = integer("id").autoIncrement().primaryKey()
//    val url = text("url")
...
//}
//
//data class LinkFromDb(val id: Long, override val url: String, override val title: String, override val comment: String?,
